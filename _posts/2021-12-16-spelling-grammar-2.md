...
In the code, there was a pretty diagram that illustrated the four relevant points to each “wave” repeated in the decoration.
...
Special thanks to [Rego](https://twitter.com/regocas), Frédéric (Igalia), [Rune](https://twitter.com/runeLi), andruud (Google), [Florian](https://twitter.com/frivoal), [fantasai](https://twitter.com/fantasai) (CSSWG), [Emilio](https://twitter.com/ecbos_) (Mozilla), and Fernando (Microsoft).
