...
function fontScale() {  // causes layout problems in FireFox that get fixed if browser's Reload is used; same may be true of other Gecko-based browsers
	...
	// 1024 / 64 
	// 768 / 48
// 87.50000000000000000000
// 56.25000000000000000000
	...
	var vScale = 50;  // both yield 16 (the usual browser default) at 1024x768
	var hScale = 80;  // perhaps should auto-calculate based on theme's declared value?
	if (window.innerHeight) {
		...
		var vSize =  832; // assuming 1400x900, minus chrome and such
		var hSize = 1400; // these do not account for kiosk mode or Opera Show
	}
